...
<div class="container">
	...
	<nav class="navbar navbar-inverse">
		...
		<ul class="nav navbar-nav navbar-justified">
			...
			<li><a href="numeros_urgence.php"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Numéros d'urgencee&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></a></li>
	...
	<?php
		...
		{
			// CRITERES 1
			$criteres1 .= " AND info_integrale LIKE '%".$recherche."%' AND annuaire_param_moteur_recherche.id_Eabonne=annuaire_exploit_abonne.id_Eabonne";
			$sqltable .= "annuaire_param_moteur_recherche,annuaire_exploit_abonne";
		}
		
		// REQUETE CRITERES 1 
		$sqlcriteres1 = "SELECT info_integrale FROM ".$sqltable."
								WHERE 1
								";
		$sqlcriteres1 .= $criteres1;
		
		// REQUETE SQL RESULTAT
		$sqlresultat = "SELECT * FROM annuaire_param_civilite,annuaire_param_fonction,annuaire_param_localisation,annuaire_param_batiment,annuaire_param_etage,annuaire_param_porte,".$sqltable."
									WHERE actif_ab=1
				...
				<div class="panel-body">
					...
					<form name="formCritère" method="post" action="">
						<div class="form-group">
							...
							<?php 
								// REQUETE SQL TYPES
								$sqltype = "SELECT distinct(type_ab) FROM ".$sqltable."
														WHERE 1
														";
								$sqltype .= $criteres1;
							...
							<?php
								...
								$sqlcivilite = "SELECT distinct(lib_civ),annuaire_param_civilite.id_Pcivilite
													FROM annuaire_param_civilite,".$sqltable."
							...
							<?php
								...
								$sqlservice = "SELECT distinct(lib_ser),annuaire_param_service.id_Pservice
													FROM annuaire_param_service,annuaire_exploit_service,".$sqltable."
													WHERE actif_ser=1
													AND annuaire_exploit_abonne.id_Eabonne=annuaire_exploit_service.id_Eabonne
													AND annuaire_param_service.id_Pservice=annuaire_exploit_service.id_Pservice
													";
							...
							<?php
								...
								$sqlfonction = "SELECT distinct(lib_fonc),annuaire_param_fonction.id_Pfonction
													FROM annuaire_param_fonction,".$sqltable."
							...
							<?php
								...
								$sqlbatiment = "SELECT distinct(lib_bat),annuaire_param_batiment.id_Pbatiment
													FROM annuaire_param_localisation,annuaire_param_batiment,".$sqltable."
