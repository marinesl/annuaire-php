...
<table class="table table-striped table-condensed">
	...
	<tbody>
		<?php
			$queryAb = mysqli_query($connectBdd, "SELECT * FROM annuaire_exploit_abonne");
			while($resultAb = mysqli_fetch_assoc($queryAb))
			{
				echo "<tr>\n";
				// echo "<td>\n";
				// echo $resultAb['id_Eabonne'];
				// echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['id_Pcivilite'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['nom_ab'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['prenom_personne'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['aph_personne'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['id_Pfonction'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['actif_ab'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['createur_ab'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['modificateur_ab'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['date_crea_ab'];
				echo "</td>\n";
				echo "<td>\n";
				echo $resultAb['date_modif_ab'];
				echo "</td>\n";
				// echo "<td>\n";
				// echo "<center><a href=\"#".$resultBat['id_Pbatiment']."\" data-toggle=\"modal\" data-backdrop=\"false\"><span class=\"glyphicon glyphicon-pencil\"></span></a></center>";
				// echo "</td>\n";
				echo "</tr>\n";
		/*?>		
