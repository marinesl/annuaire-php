...
<head>
	...
	<title>Annuaire - Modifier un étage</title>
...
<?php 
	...
	$sql2 = "SELECT * FROM annuaire_php_param_etage WHERE id_Petage=".$_POST['id'];
	...
	if (($_POST['libelle2'] == $result2[0]['lib_eta']) AND ($_POST['actif'] == $result2[0]['actif_eta']))
		$erreur_etage = 2;

	// SINON ON MODIFIE LES DONNEES 
	else {
		$sql1 = "UPDATE annuaire_php_param_etage 
