...
<head>
	...
	<title>Annuaire - Ajouter un UH</title>
...
<?php
	...
	if (!empty($_POST['libelle1']) AND !empty($_POST['numero1']) AND !empty($_POST['ua1'])) {	
		...
		$sql2 = "SELECT * FROM annuaire_php_param_uh WHERE lib_uh='".$_POST['libelle1']."'";
		...
		// SINON ON INSERE DANS LA BASE DE DONNEES ET
			...
			$sql1 = "INSERT INTO annuaire_php_param_uh
					VALUES('', '".$_POST['numero1']."', '".$_POST['libelle1']."', '".$_POST['ua1']."', '1', '".$_SESSION['ANNUAIRE_ADMIN_aph']."', '', '".date("Y-m-d H:i:s")."', '' )";
